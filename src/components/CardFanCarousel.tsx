                ...
                <div className="p-3">
                  ...
                  {organizer.linkedin && (
                    <a
                      ...
                      className="mt-2 inline-flex items-center justify-center w-7 h-7 bg-[#0077b5] border-[2px] border-black shadow-neo-sm hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all"
